/** Host UI copy only; providers supply every business-state label and action description. */
export const integrationMessages = {
  en: {
    available: 'Available integrations', install: 'Install', inspect: 'Check status',
    loading: 'Loading integrations…', loadFailed: 'Couldn’t load integrations.', retry: 'Try again',
  ...
  'zh-CN': {
    available: '可用集成', install: '安装', inspect: '检查状态',
    loading: '正在读取集成…', loadFailed: '无法读取集成。', retry: '重试',
    failed: '操作未能完成，请重试。',
