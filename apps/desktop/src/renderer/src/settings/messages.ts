...
export const settingsMessages = {
  en: {
    title: 'Settings', subtitle: 'Make Folio feel like home.', general: 'General', integrations: 'Integrations', agent: 'Agent', models: 'Agent configuration',
  ...
  'zh-CN': {
    title: '设置', subtitle: '让 Folio 更合你的习惯。', general: '通用', integrations: '集成', agent: 'Agent', models: 'Agent 配置',
