...
| IM/Email access with installed CLI | `npm run verify:lark --workspace=@folio/integrations`: check ready; IM read succeeded (1 item), Email INBOX read succeeded (1 item), before and after refresh | Verified live |
